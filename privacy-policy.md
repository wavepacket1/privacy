...
The app stores your difficulty settings (display time, move count, move speed) locally on your device using the platform's standard storage (UserDefaults on iOS, SharedPreferences on Android). This data never leaves your device.
